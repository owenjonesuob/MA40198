...
```{r p2q3_stress_plot, echo=FALSE, fig.height=1.5, out.extra = "", fig.cap="Quantiles of our approximated distribution of N"}
...
```{r p2q5_mcmc, eval=FALSE, fig.dim=c(6, 2), out.extra="", fig.cap="MCMC with our integral-approximated posterior"}
